            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ul className="ml-6 mt-2 list-disc text-[rgb(20,30,50)]">
                  ...
                  <li>Calls Google Slides API: presentations.pages.getThumbnail</li>
                  <li>Caches thumbnails in GCS with size suffixes (_small, _medium, _large)</li>
                  <li>Authenticates requests to png2gif service using Google Auth ID tokens</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="ml-6 mt-2 list-disc text-[rgb(20,30,50)]">
                  <li>
                    <strong>Libraries:</strong> gifencoder, png-file-stream, canvas
                  </li>
                  <li>
                    Downloads images from GCS matching the requested thumbnail size
                  </li>
                  <li>
                    Creates GIF with configurable delay, quality (1-20), and repeat
                    settings
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="ml-6 mt-2 list-disc text-[rgb(20,30,50)]">
                  <li>
                    ...
                    presentations/{'{presentationId}'}/slides/{'{objectId}'}_{'{size}'}.jpg
                  </li>
                  <li>
